...
// 1-st function to get average age of all users in the array

const getUserAverageAge = (array) => {
  let sum = 0;
const ages = array.map((user) => user.age);
return ages.reduce((sum, x) => sum + x) / ages.length;
}
console.log (getUserAverageAge (users));

// 2-nd function to get names of all users in the array
